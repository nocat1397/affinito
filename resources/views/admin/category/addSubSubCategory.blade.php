  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">New SubSubCategory</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-md-6">
              <div class="card p-3 shadow">
                @if (count($errors) > 0)
		            ...
		            @endif
                {!! Form::open(['method'=>'post','action'=>'SubSubCategoryController@store','files'=>true]) !!}
                <div class="form-group mt-3">
                  ...
                  <div class="form-group mt-3">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, ['class'=>'form-control text-capitalize', 'placeholder'=>'Enter SubCategory Name']) !!}
                        
                      </div>
                      <div class="form-group mt-3">

                        {!! Form::label('file', 'Upload Category Image') !!}
